...
import { Linkedin, Instagram, Facebook, Twitter, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-[#004E64] to-[#008EAA] rounded-3xl">
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        ...
        {/* Founder Cards + Scroll Buttons */}
        <div className="relative">
          {/* Scroll Buttons */}
          <button
            onClick={() => scroll('left')}
            className="absolute z-10 left-0 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 text-white p-2 rounded-full backdrop-blur-sm flex md:hidden"
          >
            <ChevronLeft />
          </button>
          ...
          <button
            ...
            className="absolute z-10 right-0 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 text-white p-2 rounded-full backdrop-blur-sm flex md:hidden"
          >
            <ChevronRight />
          </button>
          ...
          <div
            ref={scrollRef}
            className="flex overflow-x-auto gap-6 no-scrollbar px-4 md:grid md:grid-cols-2 lg:grid-cols-2"
          >
