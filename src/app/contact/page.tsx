            ...
            <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 p-10 bg-white bg-opacity-95 rounded-3xl shadow-2xl">
                ...
                <div>
                    <motion.form
                        ...
                        transition={{ duration: 0.6 }}
                        method="POST"
                        viewport={{ once: false }} // Ensures animation happens every time in view
                    >
                        <motion.h3
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: false }}
                                >
                                    <input type={field.type} id={field.id} className="input-field peer text-black" required placeholder=" " />
                        ...
                        {[
                            ...
                            >
                                {field.type === "textarea" ? (
                                    <textarea id={field.id} rows={field.rows} className="input-field peer text-black" required placeholder=" "></textarea>
                                ) : (
                                    <input type={field.type} id={field.id} className="input-field peer text-black" required placeholder=" " />
                                )}
                                <label htmlFor={field.id} className="input-label">{field.label}</label>
